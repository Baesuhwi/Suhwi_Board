...
import com.example.bsh.domain.ReplyVO;
...
//		
	...
	public JSONObject replyAdd(HttpSession session, ReplyVO ReplyVO) {
		String id = (String)session.getAttribute("id");

		ReplyVO.setId(id);
		
		Map<String, Object> map = new HashMap<String, Object>();
		int checkNum = postService.addReply(ReplyVO);
		System.out.println("replyCheckNum : " + checkNum);
